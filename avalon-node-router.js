...
exports.start = async function(req, res, routerMap, responseHeaders, errorHandler) {
	try {
		...
		if (errorHandler && errorHandler instanceof Function === true) {
			await errorHandler(e);
		} else {
			console.error('avalon-node-router: An error occured and it is not catched at all.');
			console.error('avalon-node-router: Either provide a universal errorHandler or you need to catch the error in your handler by yourself.');
		}
	}
};
